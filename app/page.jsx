...
const Homepage = () => {
 ...
 <motion.div className="h-full" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1.2}}>
    ...
    {/* image container */}
    <div className="h-1/2 lg:h-full  lg:w-1/2 relative lg:mr-32" >
      <Image src="/hero.png"  alt="image"  fill className="object-contain rounded-2xl bg-orange-200"  />
    </div>
    {/* text container */}
    <div className="h-2/3 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center    justify-center">
      {/* title */}
      <h1 className=" text-1xl  md:text-4xl lg:text-4xl w-full text-white font-bold"> Hi I am <span className="text-red-400">M</span>uhammad <span className="text-red-400">N</span>aveed Mern Stack Developer  </h1>
  
      {/* desc */}
      <p className="-mt-6 md:-mt-4 md-text-xl  text-1xl  text-white">Welcome to my portfolio I am a dedicated MERN stack developer with a strong passion for building scalable and efficient web applications. With a solid foundation in MongoDB, Express.js, React, and Node.js, I bring a comprehensive skill set to every project I undertake.
</p>
